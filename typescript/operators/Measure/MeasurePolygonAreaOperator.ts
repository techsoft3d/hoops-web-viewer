namespace Communicator.Operator {
    export enum MeasurePolygonAreaAnchor {
     ...
     */
    export class MeasurePolygonAreaOperator extends OperatorBase {
        private _cursor: Common.PointCursor;
        private _markupItem: Markup.Measure.MeasurePolygonAreaMarkup | null = null;
        private _measureManager: MeasureManager;
        private _cameraInteractionActive = false;
        private _textShapeOffset = new Point2(10, -25);
        private _anchor = MeasurePolygonAreaAnchor.Last;
        ...
        public setAnchor(anchor: MeasurePolygonAreaAnchor) {
            this._anchor = anchor;
        }
        ...
        private _createNewMarkupItem(selection: Common.SelectionPoints) {
            this._markupItem = new Markup.Measure.MeasurePolygonAreaMarkup(this._viewer);
            ...
            this._markupItem.setName("MeasurePolygonAreaMarkup");
        ...
        private _updateMarkupItem(pointerPosition: Point2, selection: Common.SelectionPoints) {
            ...
            if (Point2.distance(firstPos, pointerPosition) < this._markupItem.pointRadius) {
                ...
                const wasAdded = this._markupItem.addPoint(selection.worldPosition);
                if (wasAdded) {
        ...
        private _updateAnchor(pointerPosition: Point2, worldPos: Point3) {
            ...
            switch (this._anchor) {
                case MeasurePolygonAreaAnchor.Last:
                    this._calculateAnchorPos(pointerPosition, worldPos);
                    break;
                case MeasurePolygonAreaAnchor.First: {
                ...
                case MeasurePolygonAreaAnchor.Midpoint: {
        ...
        protected _pickExisting(selectPoint: Point2): boolean {
            ...
            if (
                markup &&
                markup.getClassName() === "Communicator.Markup.Measure.MeasurePolygonAreaMarkup"
            ) {
                this._markupItem = markup as Markup.Measure.MeasurePolygonAreaMarkup;
                return true;
            } else {
                return false;
            }
