namespace Communicator.Operator {
    ...
    export class SpaceMouseOperator extends OperatorBase {
        ...
        private _client: _3Dconnexion.Client = {
            onConnect: () => {
            ...
            getPerspective: () => {
                return this._viewer.view.getCamera().getProjection() === Projection.Perspective;
            },
            ...
            getViewMatrix: () => {
                ...
                const eye = Point3.subtract(camera.getTarget(), camera.getPosition()).normalize();
            ...
            getPointerPosition: () => {
                const mouse3dPoint = this._viewer.view.unprojectPoint(this._ptCurrent, 0);
         ...
         */
        public connect(): void {
            this._connexion = new _3Dconnexion(this._client);
